...
// Fix: Changed props types from void to () => void to allow them to be used as event handlers and called.
...
const AboutUs: React.FC = () => {
  ...
  const qabWorks = [
    {
      title: "Bosque Rocks!",
      image: "https://lavender-worrying-clam-733.mypinata.cloud/ipfs/bafybeident7i4pmkobx2zwhlb6itsbyqp7v7gtrpcmkjm4yuja2zsiiphq",
      desc: t.brDesc,
      link: "https://drop.art/bm/5fNTkMrlM2Isos4xYaiXEU",
      linkText: t.checkHere
    },
    {
      title: "Based House Heads",
      image: "https://lavender-worrying-clam-733.mypinata.cloud/ipfs/bafybeiezgsg54gxdyj5r6tr2z33son3zeoclmagbyjt7zxeey3bduagtre",
      desc: t.bhhDesc,
      link: "https://based-house-heads.vercel.app/",
      linkText: t.checkHere
    },
    {
      title: "Pinturas",
      image: "https://lavender-worrying-clam-733.mypinata.cloud/ipfs/bafybeielsqzdzaeqxgkrcyycwxk6o7sm5wn7wlcj2anr6bmn4z36rbc7g4",
      desc: t.pinturasDesc,
      link: "https://qabqabqab.github.io/",
      linkText: t.checkHere
    }
  ];
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    document.title = selectedProject ? `3spiral | ${selectedProject.title}` : "3spiral";
  }, [selectedProject]);
